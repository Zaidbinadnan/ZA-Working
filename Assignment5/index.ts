...
} else console.log("Q9:You are eligible to cast the vote");
...
function removeFalseyValues(abcarray: any[]): any[] {
...
function sumOfEllements(numbers: number[]) {
  let sum = 0;
...
function smallestNumber(numbers: number[]): number {
...
const n = 5;
function filterbyLenght(string: string[], n: number): string[] {
...
function convertTempInCelsius(fahrenheitTemperature: number[]): number[] {
